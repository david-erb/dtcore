...
// --------------------------------------------------------------------------------------------
// Test store_pixel/fetch_pixel against directly seeded buffer bytes
dterr_t*
test_dtraster_rgba8888_store_then_fetch_pixel(void)
{
    dterr_t* dterr = NULL;
    ...
    DTUNITTEST_ASSERT_TRUE(!dtrgba8888_compare(pixel, actual));
...
dterr_t*
test_dtraster_rgba8888_blit_middle(void)
{
    dterr_t* dterr = NULL;
    dtraster_handle raster1_handle = NULL;
    dtraster_handle raster2_handle = NULL;
    dtraster_handle raster3_handle = NULL;
    dtrgba8888_t pixel1 = { 22, 33, 44, 0xff };
    dtrgba8888_t pixel2 = { 55, 66, 77, 0xff };
...
dterr_t*
test_dtraster_rgba8888_blit_clip_right_bottom(void)
{
    dterr_t* dterr = NULL;
    dtraster_handle raster1_handle = NULL;
    dtraster_handle raster2_handle = NULL;
...
dterr_t*
test_dtraster_rgba8888_blit_clip_left_top(void)
{
    dterr_t* dterr = NULL;
    dtraster_handle raster1_handle = NULL;
    dtraster_handle raster2_handle = NULL;
...
// suite runner
void
test_dtraster_rgba8888(DTUNITTEST_SUITE_ARGS)
{
    DTUNITTEST_RUN_TEST(test_dtraster_rgba8888_store_then_fetch_pixel);
    DTUNITTEST_RUN_TEST(test_dtraster_rgba8888_blit_middle);
    DTUNITTEST_RUN_TEST(test_dtraster_rgba8888_blit_clip_right_bottom);
    DTUNITTEST_RUN_TEST(test_dtraster_rgba8888_blit_clip_left_top);
}